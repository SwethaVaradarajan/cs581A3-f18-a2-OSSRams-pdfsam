...
class SelectionTableToolbar extends ToolBar implements ModuleOwned {
    ...
    static class MoveTopButton extends BaseMoveSelectedButton {
        ...
        public MoveTopButton(String ownerModule) {
            ...
            setTooltip(new Tooltip(DefaultI18nContext.getInstance().i18n("Moves selected documents to top")));
    ...
    static class MoveBottomButton extends BaseMoveSelectedButton {
        ...
        public MoveBottomButton(String ownerModule) {
            ...
            setTooltip(new Tooltip(DefaultI18nContext.getInstance().i18n("Moves selected documents to bottom")));
